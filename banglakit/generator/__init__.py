...
def generate():
    d = {}
    d.update(generate_for('কর গড় চর ছড় ঝর নড় পর পড় ভর মর সর হাঁট কাট হাঁট ঘাট ছাট'.split(), [rule_1, rule_2]))
    d.update(generate_for('দৌড় ঝিম ঘুম চাল থাম কাম'.split(), [rule_2]))
